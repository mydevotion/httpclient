...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (connManagerCopy == null) {
            ...
            //初始化PoolingHttpClientConnectionManager对象，实际上和默认的空的构造函数执行的逻辑差不多
            ...
            //这个地方即使不设置，在 poolingmgr调用connect方法的时候会给一个默认值
        ...
        // 默认三次重试机会，可以通过设置automaticRetriesDisabled为true不重试

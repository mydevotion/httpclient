...
public class PoolingHttpClientConnectionManager
    ...
    /**
     * PoolingHttpClientConnectionManager构造函数
     *
     * @param socketFactoryRegistry Registry对象
     * @param connFactory           HttpConnectionFactory对象
     * @param schemePortResolver    SchemePortResolver对象
     * @param dnsResolver           DnsResolver对象
     * @param timeToLive            timeToLive
     * @param tunit                 TimeUnit对象
     */
    public PoolingHttpClientConnectionManager(
            final Registry<ConnectionSocketFactory> socketFactoryRegistry,
            final HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> connFactory,
    ...
    public PoolingHttpClientConnectionManager(
        ...
        //  defaultMaxPerRoute为2,maxTotal为20
    ...
    public ConnectionRequest requestConnection(
        ...
        // lease租约，租期,先根据HttpRoute获取第一层缓存RouteSpecialficPool,然后再根据HttpRoute获取第二层缓存

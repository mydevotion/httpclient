 ...
 * @since 4.2
 */
// T是HttpRoute, C是ManagedHttpClientConnection,E是CPoolEntry
@ThreadSafe
public abstract class AbstractConnPool<T, C, E extends PoolEntry<T, C>>
    ...
    /**
     * 根据route去缓存中获取RouteSpecificPool
     * <p> T是HttpRoute, C是ManagedHttpClientConnection,E是CPoolEntry  </p>
     * <p>
     * CPoolEntry实际上并没有缓存信息，只是一个Entry对象。RouteSpecificPool做了对CPoolEntry的缓存，
     * 实际上就是一个T是HttpRoute，对应多个CPoolEntry，而他们之间的对应关系由RouteSpecificPool负责
     * </p>
     *
     * @param route
     * @return
     ...
     * <p>
     * 需要注意的是，本类不提供缓存池。因此，必须要调用该方法返回对象{@link Future}的get方法
     * </p>
     * 需要特别注意一下PoolEntryFuture的get方法
     * <p> T是HttpRoute, C是ManagedHttpClientConnection,E是CPoolEntry  </p>
     */
    @Override
    public Future<E> lease(final T route, final Object state, final FutureCallback<E> callback) {
        ...
        return new PoolEntryFuture<E>(this.lock, callback) {
            ...
            // 该方法在调用get的时候被调用，实际上，从实现来看，还是AbstractConnPool实现了连接池
            @Override
    ...
    private E getPoolEntryBlocking(
        ...
        this.lock.lock();
        try {
            //RouteSpecificPool做了对CPoolEntry的缓存，实际上就是一个HttpRoute，对应多个CPoolEntry
            ...
            while (entry == null) {
                ...
                // 如果超过每个HttoRoute的最大连接数，收缩缓存，优先分配一个新的连接
    ...
    /**
     * 根据route获取该route的最大连接数，如果没有，则取默认值
     *
     * @param route
     * @return
     */
